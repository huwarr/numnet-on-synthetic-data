...
def add_data_args(parser: ArgumentParser):
    parser.add_argument(
        ...
        type=int,
        help="training gpu num.",
    )
    parser.add_argument(
        "--data_dir", default="", type=str, required=True, help="data dir."
    )
    parser.add_argument(
        "--save_dir", default="", type=str, required=True, help="save dir."
    )
    parser.add_argument(
        "--log_file", default="train.log", type=str, help="train log file."
    )
...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument(
        "--log_per_updates", default=20, type=int, help="log pre update size."
    )
    ...
    parser.add_argument(
        "--grad_clipping", default=1.0, type=float, help="gradient clip."
    )
    parser.add_argument(
        "--warmup",
        type=float,
    ...
    parser.add_argument(
        "--warmup_schedule", default="warmup_linear", type=str, help="warmup schedule."
    )
    parser.add_argument(
        "--optimizer", default="adam", type=str, help="train optimizer."
    )
    parser.add_argument(
        "--seed",
        type=int,
    ...
    parser.add_argument(
        "--pre_path", type=str, default=None, help="Load from pre trained."
    )
...
def add_model_args(parser: ArgumentParser):
    parser.add_argument(
        "--use_gcn", action="store_true", help="Using graph infomation."
    )
    parser.add_argument("--gcn_steps", default=1, type=int, help="max gcn steps.")
    parser.add_argument(
        "--tag_mspan", action="store_true", help="tag based mspan prediction model."
    )
