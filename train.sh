...
TEST_CONFIG="--eval_batch_size 5 --pre_path ${SAVE_DIR}/checkpoint_best.pt --data_mode dev --dump_path_numeric ${SAVE_DIR}/dev_num.json \
             --dump_path_textual ${SAVE_DIR}/dev_text.json --inf_path_numeric ${DATA_DIR}/synthetic_numeric_dev_drop_format.json \
             --inf_path_textual ${DATA_DIR}/synthetic_textual_mixed_min3_max6_up0.7_dev.json"
